...
This directory contains source files for the Woods Cree language
...
-   <http://giellatekno.uit.no/cwddoc/index.html>
-   <https://giellalt.uit.no/tools/docu-cwd-manual.html>
...
The Woods Cree language sources can be acquired using [giella SVN
